...
namespace AtomicTorch.CBND.CoreMod.Items.Generic
{
        ...
        where TClientState : BaseClientState, new()
    {
        ...
        protected static GetPlantResult SharedGetAvailablePlantAt(Vector2Ushort tilePosition, ICharacter character)
        {
        ...
        protected bool ServerRemote_ApplyFertilizer(Vector2Ushort tilePosition, IItem item)
        {
        ...
        protected struct GetPlantResult : IRemoteCallParameter
        {
